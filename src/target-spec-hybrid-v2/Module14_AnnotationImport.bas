...
Private Function ViewHasDrawingGeometry( _
    ...
    Dim count As Long
    count = swView.GetVisibleEntityCount2(Nothing, 1)

    ViewHasDrawingGeometry = (count > 0)
    Exit Function
...
Public Sub R23_ProbeAnnotationReconciliation()
    ...
    If swApp Is Nothing Then
        Debug.Print "R23_ANNOTATION_FATAL|reason=SolidWorksUnavailable"
        Exit Sub
    End If
    ...
    If swDraw Is Nothing Then
        Debug.Print "R23_ANNOTATION_FATAL|reason=NoActiveDocument"
        Exit Sub
    End If

    If swDraw.GetType <> swDocDRAWING Then
        Debug.Print "R23_ANNOTATION_FATAL|reason=ActiveDocumentNotDrawing"
        Exit Sub
    End If
    ...
    If IsEmpty(views) Or Not IsArray(views) Then
        Debug.Print "R23_ANNOTATION_FATAL|reason=NoViewsOnSheet"
        Exit Sub
    End If
    ...
    If swPart Is Nothing Then
        Debug.Print "R23_ANNOTATION_FATAL|reason=NoReferencedDocument"
        Exit Sub
    End If
    ...
    If Not Module1_Main.IsAuthorizedFixture(partPath) Then
        Debug.Print "R23_ANNOTATION_FATAL|reason=UnauthorizedFixture" & _
            "|path=" & partPath
        Exit Sub
    End If
    ...
    Debug.Print "R23_ANNOTATION_BEGIN|drawing=" & swDraw.GetPathName & _
        "|part=" & partPath & _
    ...
    If Not Module12_FeatureQualification.BuildFeatureCatalog( _
        ...
        Debug.Print "R23_ANNOTATION_FATAL|reason=CatalogUnavailable"
        Exit Sub
    End If
...
ContinueProjectionView:
    ...
    Debug.Print "R23_ANNOTATION_GRAPH|" & graph.GraphSummary()
    ...
    For i = LBound(views) To UBound(views)
        ...
        Debug.Print "R23_ANNOTATION_POLICY|view=" & _
...
ContinuePolicyView:
    ...
    Debug.Print "R23_ANNOTATION_END|" & graph.GraphSummary() & _
...
Failed:
    Debug.Print "R23_ANNOTATION_FATAL|reason=UnhandledError" & _
