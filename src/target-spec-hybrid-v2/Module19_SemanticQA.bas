...
Public Sub R23_ProbeSemanticQA()
    ...
    If swApp Is Nothing Then
        Debug.Print "R23_SEMANTICQA_FATAL|reason=SolidWorksUnavailable"
        Exit Sub
    End If
    ...
    If swDraw Is Nothing Then
        Debug.Print "R23_SEMANTICQA_FATAL|reason=NoActiveDocument"
        Exit Sub
    End If

    If swDraw.GetType <> swDocDRAWING Then
        Debug.Print "R23_SEMANTICQA_FATAL" & _
    ...
    If IsEmpty(views) Or Not IsArray(views) Then
        Debug.Print "R23_SEMANTICQA_FATAL|reason=NoViewsOnSheet"
        Exit Sub
    End If
    ...
    If swPart Is Nothing Then
        Debug.Print "R23_SEMANTICQA_FATAL|reason=NoReferencedDocument"
        Exit Sub
    End If
    ...
    If Not Module1_Main.IsAuthorizedFixture(partPath) Then
        Debug.Print "R23_SEMANTICQA_FATAL|reason=UnauthorizedFixture" & _
            "|path=" & partPath
        Exit Sub
    End If
    ...
    Debug.Print "R23_SEMANTICQA_BEGIN|drawing=" & swDraw.GetPathName & _
        "|part=" & partPath & _
    ...
    If Not Module12_FeatureQualification.BuildFeatureCatalog( _
        ...
        Debug.Print "R23_SEMANTICQA_FATAL|reason=CatalogUnavailable"
        Exit Sub
    End If
...
ContinueProjectionView:
    ...
    For i = LBound(views) To UBound(views)
        ...
        If path.Resolved Then Set bestPath = path
...
ContinuePathView:
    ...
    If sectionViews.Count > 0 Then
        ...
        EvaluateSectionDimensions requirements, sectionDimensions, _
            evidence
    Else
        evidence.MarkStageFailed STAGE_SECTION_DIMENSIONS, _
    ...
    If Module18_ContentEnvelope.MeasureSheetRegions( _
        ...
        For i = LBound(views) To UBound(views)
            ...
            Set envelope = Module18_ContentEnvelope.BuildViewEnvelope( _
                envelopeView, evidence.SheetWidth, _
                evidence.SheetHeight, evidence)
...
ContinueEnvelopeView:
        ...
        EvaluateFinalLayout envelopes, viewList, _
            Module18_ContentEnvelope.BuildProtectedRegions(evidence), _
            evidence
    Else
        evidence.MarkStageFailed STAGE_FINAL_LAYOUT, _
    ...
    ' Seals the declared stages, so any stage nothing proved becomes a
    ' named failure rather than an absence nobody notices.
    ...
    Debug.Print "R23_SEMANTICQA_END|" & StageReport(evidence) & _
...
Failed:
    Debug.Print "R23_SEMANTICQA_FATAL|error=" & CStr(Err.Number) & _
